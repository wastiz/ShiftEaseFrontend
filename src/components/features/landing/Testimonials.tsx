                ...
                >
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3 pt-2 border-t border-white/10">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary/30 to-coralPrimary/30 text-sm font-semibold text-textPrimary">
